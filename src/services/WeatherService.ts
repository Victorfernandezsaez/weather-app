...
const apiKey: string | undefined = import.meta.env.VITE_REACT_APP_OPEN_WEATHER_API_KEY as string;
if (apiKey === undefined) {
    throw new Error('No Open Weather API Key defined - ensure you set a variable called VITE_REACT_APP_OPEN_WEATHER_API_KEY');
}
